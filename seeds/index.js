...
const seedDB = async() => {
    ...
    for(let i=0;i<50;i++) {
        ...
        const data = new Campground({
            ...
            description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, eius soluta enim consectetur labore perferendis molestias sed reiciendis repudiandae mollitia officiis maiores minima autem quaerat fugit, facere ut qui numquam.",
            price:price
        })
        await data.save();
    }
